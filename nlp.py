...
# Remove punctuation from stopWords, since punctuation is removed from input sentences:
...
def stripToProperty(workingQuestionString, realPlaceName):
    ...
    for stopWord in stopWords:
        ...
        if stopWord in workingQuestionString:
            workingQuestionString = filter(lambda a: a != stopWord, workingQuestionString)
